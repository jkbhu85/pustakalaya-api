		...
		private String encode (JwtPayload payload) throws JWTCreationException {
			...
			Builder builder = 
					jwtBuilder
						...
						.withArrayClaim(JwtPayload.PAYLOAD_KEY_ROLES, payload.getRoles().toArray(new String[] {}))
		...
		private JwtPayload decode(String token) throws JWTVerificationException {
			...
			JwtPayload payload = 
					new JwtPayload(
							...
							Arrays.asList(jwt.getClaim(JwtPayload.PAYLOAD_KEY_ROLES).asArray(String.class))
							);
